package com.example.wsqlitecrudxansomnia;
        ...
        c = lista.get(posicion);
            ...
            eliminar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    del.setPositiveButton("SIPI UWU", new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    del.setNegativeButton("NO Q^Q", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
